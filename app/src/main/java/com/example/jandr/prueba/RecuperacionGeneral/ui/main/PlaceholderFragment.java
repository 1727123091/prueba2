package com.example.jandr.prueba.RecuperacionGeneral.ui.main;
...
public class PlaceholderFragment extends Fragment {
    ...
    public static Fragment newInstance(int index) {
        ...
        switch (index){
            case 1: fragment = new RecuperacionGeneral1();break;
            case 2: fragment = new RecuperacionGeneral2();break;
            case 3: fragment = new RecuperacionGeneral3();break;
            case 4: fragment = new RecuperacionGeneral4();break;
        }
    ...
    public View onCreateView(
        ...
        View root = inflater.inflate(R.layout.fragment_recuperacion_instrucciones_general, container, false);
