...
public class Gargaras extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gargaras);
        ...
        youTubeVideos.add( new YouTubeVideos("<iframe width=\"100%\" height=\"100%\" src=\"https://www.youtube.com/embed/yTCfPtk7wrE\" frameborder=\"0\" allowfullscreen></iframe>"));
