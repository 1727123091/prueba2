...
import com.example.jandr.prueba.TratamientoEmbarazada.ui.main.SectionsPagerAdapter;

public class TratamientoInstruccionesEmbarazada extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tratamiento_instrucciones_embarazada);
